...
const Web = props => {
  return (
    <Layout
      title="Build & make games/videogames"
      desc="Frameworks, libraries and tools to help you make games/videogames"
    >
...
Web.getInitialProps = async function(context) {
  ...
  if (!type) {
    var result = provider.getByTagsOnly("games", p ? p : 0);
  } else {
    var result = provider.getBy("games", p ? p : 0, type);
  }
